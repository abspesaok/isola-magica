...
3. **Poco stress, tanto gioco**: si impara con gemme, stelle, avatar e storie — la bambina jgioca, non "studia".
4. **Dal singolo alla frase**: prima le parole (rosso, gatto), poi si combinano ("the red cat"), poi frasi intere.
...
| 3 | Lo Specchio della Principessa | **Famiglia** e **parti del corpo** *(← Lidia è qui)* |
...
## 5. Dove dobbiamo arrivare — e quante isole al massimo

**La meta:** una bambina che **usa** l'inglese invece di "studiarlo" — capisce, parla di sé e del suo mondo, legge storie semplici, scrive qualche frase e regge una piccola conversazione.
